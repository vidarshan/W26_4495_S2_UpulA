...
export default function PayStubPage() {
  ...
  return (
    <Container py="xl" className="staff-app-page">
      <Stack gap="lg">
        <Card
          withBorder
          radius="lg"
        ...
        >
          <Stack gap="md">
            <Group justify="space-between" align="end" gap="md">
              ...
              <Button variant="default" radius="lg" size="md" onClick={handleDownloadPdf}>
                Download PDF
              </Button>
            </Group>
        ...
        <Card withBorder radius="lg" p={{ base: 'sm', sm: 'md' }} className="staff-app-surface">
          <Stack gap="md">
            <Box
              p="md"
              style={{
          ...
          >
            ...
            {/* EMPLOYEE INFO */}
            <Box mb="md" p="sm" style={{ border: '1px solid black', borderRadius: 16 }}>
              <Grid>
                <Grid.Col span={6}>
                  <Text>
